  ...
  return (
    <div>
      <div className="flex absolute flex-wrap justify-center gap-12 bg-white p-[35px] rounded-lg left-[25%] z-10 shadow-md lg:flex-wrap md:flex-wrap">
          ...
          <div className='flex gap-3'>
            <Image src={"/images/icon_2.png"} alt='img' width={60} height={0} />
            <div className='flex flex-col text-left p-2'>
              <a className='text-black font-bold text-lg'>825+</a>
              <p className='text-black font-normal'>xxx</p>
            </div>
          ...
          <div className='flex gap-3'>
            <Image src={"/images/icon_3.png"} alt='img' width={60} height={0} />
            <div className='flex flex-col text-left p-2'>
              <a className='text-black font-bold text-lg'>825+</a>
              <p className='text-black font-normal'>xxx</p>
            </div>
          ...
          <div className='flex gap-3'>
            <Image src={"/images/icon_4.png"} alt='img' width={60} height={0} />
            <div className='flex flex-col text-left p-2'>
              <a className='text-black font-bold text-lg'>825+</a>
              <p className='text-black font-normal'>xxx</p>
            </div>
