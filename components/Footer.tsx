    ...
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left h-[30vh]">
      <div className="flex items-center justify-center bg-[#13a6b8]  border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between ">
        <div className="mr-12 hidden lg:block">
          <span className="text-white font-semibold px-[80px]">
            CONNECT WITH UNAVAR TODAY
          </span>
        </div>
        <div className="flex justify-center px-[60px]">
          <button className="bg-transparent border border-white text-white font-bold py-2 p-6 rounded-lg outline-white hover:bg-white hover:text-cyan-400 hoever:outline-offset-2">
            Contact Us
          </button>
        </div>
      </div>
      <div className="flex gap-7 justify-center p-[30px] bg-white h-[25vh]">
        ...
        <div className="w-[30vw] h-[10vh]">
          ...
          <div className="text-center indent-16 text-wrap">
            <p className="text-blank">abc@gmail.com</p>
          </div>
        </div>
      </div>
      <hr></hr>
      <div className="flex justify-around gap-10 h-[20vh] bg-white p-[40px]">
        <div className="w-[70vw] h-[40vh]">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-9">
              ...
              <button className="w-[12vw] h-[7vh] bg-transparent border border-lime-500 text-lime-500 font-light py-2 px-6 rounded-lg hover:bg-lime-500 hover:text-white">
                Know more
              </button>
            </div>
          </div>
